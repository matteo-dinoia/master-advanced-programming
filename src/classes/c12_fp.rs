...
pub mod closures {
    ...
    fn create_fn_para<'a>(text: &'a String) -> impl FnOnce() + 'a {
        let text = "FnOnce".to_owned();
        move || println!("This is a: {}", text)
    }

    fn create_fn_para2<'a, 'b: 'a>(text: &'a String, text2: &'b String) -> impl FnOnce() + 'a {
        let text = "FnOnce".to_owned();
        move || println!("This is a: {}", text)
    }
